...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('rapat-internal', function (Blueprint $table) {
            $table->id('rapat_internal')->required();
            ...
            $table->string('nama_rapat_internal', 250)->required();
            $table->string('nomor_surat', 100);
            $table->date('tanggal_surat');
            $table->string('scan_undangan', 100);
            $table->string('scan_daftar_hadir', 100);
    ...
    {
        Schema::dropIfExists('rapat-internal');
    }
};
